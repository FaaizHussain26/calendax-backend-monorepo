...
export class InitialSchema1775498775827 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."users_usertype_enum" AS ENUM('TENANT_ADMIN', 'TENANT_STAFF', 'PATIENT')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."otps_purpose_enum" AS ENUM('general', 'verification', 'reset_password')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "user_direct_permissions" ("userId" uuid NOT NULL, "permissionId" uuid NOT NULL, CONSTRAINT "PK_a298570ccbdb7e273d7abcf7f96" PRIMARY KEY ("userId", "permissionId"))`,
    );
    await queryRunner.query(`CREATE INDEX "IDX_1e14c4b2ec1adda08ea3c0b027" ON "user_direct_permissions" ("userId") `);
    await queryRunner.query(
      `CREATE INDEX "IDX_f83152f7ccfa59cc136630e4be" ON "user_direct_permissions" ("permissionId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_direct_permissions" ADD CONSTRAINT "FK_1e14c4b2ec1adda08ea3c0b0274" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_direct_permissions" ADD CONSTRAINT "FK_f83152f7ccfa59cc136630e4bed" FOREIGN KEY ("permissionId") REFERENCES "permissions"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
