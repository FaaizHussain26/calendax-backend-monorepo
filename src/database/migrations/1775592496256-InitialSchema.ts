...
export class InitialSchema1775592496256 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "site_protocols" ("protocolId" uuid NOT NULL, "siteId" uuid NOT NULL, CONSTRAINT "PK_3f7b179544b26572a658c235cdd" PRIMARY KEY ("protocolId", "siteId"))`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "user_sites" ("userId" uuid NOT NULL, "siteId" uuid NOT NULL, CONSTRAINT "PK_ca67719284ca1e8d8923a675ae7" PRIMARY KEY ("userId", "siteId"))`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."users_usertype_enum" AS ENUM('TENANT_ADMIN', 'TENANT_STAFF', 'PATIENT', 'PRINCIPLE_INVESTIGATOR')`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "protocols" ADD CONSTRAINT "FK_d721341df568f28b79f8fefd43d" FOREIGN KEY ("indicationId") REFERENCES "indications"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "sites" ADD CONSTRAINT "FK_dbebf9dd6ece5b8577b8c11e7e4" FOREIGN KEY ("indicationId") REFERENCES "indications"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "site_protocols" ADD CONSTRAINT "FK_c828c6fcdf74ed1bee839fc9a56" FOREIGN KEY ("protocolId") REFERENCES "protocols"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "site_protocols" ADD CONSTRAINT "FK_4e5bd0f6774c2eba00ef3a7f9f4" FOREIGN KEY ("siteId") REFERENCES "sites"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_sites" ADD CONSTRAINT "FK_832c931a178f7619cd565b4a665" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_sites" ADD CONSTRAINT "FK_f4e0fdd55e0d722a91678905394" FOREIGN KEY ("siteId") REFERENCES "sites"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."users_usertype_enum_old" AS ENUM('TENANT_ADMIN', 'TENANT_STAFF', 'PATIENT')`,
    );
    await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "userType" DROP DEFAULT`);
    await queryRunner.query(
