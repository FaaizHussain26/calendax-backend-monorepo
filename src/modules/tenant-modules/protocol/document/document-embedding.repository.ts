...
import { IProtocolDocument, PROTOCOL_DOCUMENT_COLLECTION } from '@libs/common/interfaces/collections/protocol-document.interface';
import { DocumentChunk } from '@libs/common/interfaces/document.interface';
